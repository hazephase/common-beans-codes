<?php
/** add this to beans main theme lib/templete/fagrment
 * Echo menu fragments.
 *
...
function beans_primary_menu() {
	...
	$nav_visibility = current_theme_supports( 'offcanvas-menu' ) ? 'uk-navbar-nav' : '';

	beans_open_markup_e( 'beans_primary_menu', 'nav', array(
		'class'     => 'tm-primary-menu uk-float-right uk-navbar-container ',
		'role'      => 'navigation',
		'itemscope' => 'itemscope',
